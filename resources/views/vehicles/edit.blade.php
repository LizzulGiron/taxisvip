            ...
            <div class="row">
                <div class="page-header" id="top" style="width: 100%">
                    ...
                    <p class="breadcrumb-link" style="font-weight: bold;">
                        A continuación se le mostrará la información correspondiente al vehículo.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div id="accordion3">
                            ...
                            <div class="card mb-2 border-3 border-top border-top-primary">
                                ...
                                <div id="collapseEight" class="collapse show" aria-labelledby="headingEight" data-parent="#accordion3" style="">
                                    <div class="card-body">
                                        <form action="{{url('/vehiculos/'.$vehicle->id)}}" method="post">
                                            {{ csrf_field() }}
                                            {{ method_field('PATCH')}}
                                            <div class="row">
                                                <div class="container">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="model_id" value="{{old('year')}}">
                                                                @foreach($models as $model)
                                                                    <option value="{{$model->id}}" {{ old('model_id',$model->id) == "$vehicle->model_id" ? "selected" : "" }} >{{$model->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="register" class="form-control" value="{{$vehicle->register}}" maxlength="7">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="color" class="form-control" value="{{$vehicle->color}}" maxlength="25">
                                                            </div>
                                                        </div>
