        ...
        <div class="container">
            <div class="row">
                <div class="page-header" id="top" style="width: 100%">
                    <h2 class="pageheader-title"><b>Realiza el pago por comisiones aquí.</b></h2>
                    <hr style="margin-top: -5px;margin-bottom: 5px;">
                    <p class="breadcrumb-link" style="font-weight: bold;">
                        A continuación se brinda la información correspondiente a las carreras realizadas en un determinado período de tiempo.
                    </p>
                </div>
            </div>
        </div>
                                   ...
                                   <div class="mb-3">
                                    ...
                                    <div class="d-block my-3" style="padding-top:-20px">
                                        ...
                                        <div class="alert alert-danger">
                                            <p>
                                                <span><b>NOTA : </b></span>
                                                La fecha de pago para esta factura es el <b>{{$payment_date}}</b>, por cada día de retraso en el pago de una factura se cobrará un recargo de L 100.
                                            </p>
                                        </div>
                                    </div>
                                    <hr class="mb-4">
                                    <button class="btn btn-warning btn-lg btn-block" type="submit">Realizar Pago</button>
                                </form>
                            </div>
                        </div>
                    </div>
