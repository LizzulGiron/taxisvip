        ...
        <div class="container">
            <div class="row">
                <div class="page-header" id="top" style="width: 100%">
                    <h2 class="pageheader-title"><b>Actualización de registros.</b></h2>
                ...
                <div class="card border-3 border-top border-top-primary">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <form action="{{url('/modelos/'.$model->id)}}" method="POST">
                                    {{ csrf_field() }}
                                    {{ method_field('PATCH')}}
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="name" class="form-control" value="{{$model->name}}" maxlength="50" placeholder="Nombre" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="brand_id">
                                                    @foreach($brands as $brand)
                                                        <option value="{{$brand->id}}" {{ old('brand_id',$brand->id) == "$model->brand_id" ? "selected" : "" }} >{{$brand->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div><br>
                                        </div>
