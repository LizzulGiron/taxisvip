        ...
        <div class="container">
            <div class="row">
                <div class="page-header" id="top" style="width: 100%">
                    <h2 class="pageheader-title"><b>Modelos de vehículos registrados en el sistema</b></h2>
                    <hr style="margin-top: -5px;margin-bottom: 5px;">
                    <p class="breadcrumb-link" style="font-weight: bold;">
                        Gestiona la información correspondiente a los modelos de vehículos aquí.
                    </p>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group ml-auto">
                                                    <a href="{{ url('/modelos/'.$model->id.'/edit')}}" class="btn btn-sm btn-outline-light">Editar</a>

                                                    <button type="submit" onclick="notification('{{$model->id}}')" class="btn btn-sm btn-outline-ligh" style="display: none">
    ...
    function notification(id){
        Swal.fire({
            ...
            '<div class="text-right" style="margin-top:-5px">'+
                '<form action="modelos/'+id+'" method="POST">'+
                    '{{ csrf_field() }}'+
                    '{{ method_field("DELETE")}}'+
